<template>
	<div>
		...
		<el-row class="text-right">
			<el-text @click="redirectTocall">倡议</el-text>
		</el-row>
...
export default {
    data() {
        return {
            days: null,
            list: [
                { type: '蔬菜类', effect: '富含大量维生素C有益于人体健康，防止坏血病，提高人体免疫力' },
                { type: '瓜果类', effect: '富含大量维生素C有益于人体健康，防止坏血病，提高人体免疫力' },
                { type: '蛋奶类', effect: '尽量通过蛋奶类饮食代替肉类，既能低碳，又能减少过度摄入肉类饱和脂肪酸对人体的危害' },
            ],
            progress: 0,
			points: 0, // 新增积分字段
        }
    ...
    methods: {
        ...
        redirectTomonthvegecheck() {
            // 跳转到打卡页面
            uni.navigateTo({
                url: '/pages/monthvegecheck/monthvegecheck'
            });
        },
        calculateProgress() {
